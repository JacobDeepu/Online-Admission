    ...
    <div class="py-12">
        <div class="mx-auto max-w-7xl sm:px-6 lg:px-8">
            <div class="relative overflow-hidden bg-white shadow-xl dark:bg-gray-800 sm:rounded-lg">
                ...
                <form class="p-4" method="POST" action="{{ route('institutions.store') }}" enctype="multipart/form-data">
                    @csrf
                    <div class="mb-4 grid gap-4 sm:grid-cols-2">
                        <div class="row-span-2 flex flex-col items-center justify-end" x-data="{ logoName: null, logoPreview: '{{ old('logo_file_path') }}' }">
                        ...
                        <div class="row-span-2 flex flex-col items-center justify-end" x-data="{ headerName: null, headerPreview: '{{ old('header_file_path') }}' }">
                        ...
                        <div>
                            ...
                            <x-input class="mt-1 block w-full" id="name" name="name" type="text" :value="old('name')" required />
                        </div>
                        <div>
                        ...
                        <div>
                            ...
                            <x-input class="mt-1 block w-full" id="phone" name="phone" type="text" :value="old('phone')" required />
                        </div>
                        <div>
                            <x-label for="name" value="{{ __('Color Code') }}" />
                            <x-input class="mt-1 block w-full" id="color_code" name="color_code" type="text" :value="old('color_code')" required />
                        </div>
                    </div>
                    <div class="mt-4 flex">
                        <x-button>
